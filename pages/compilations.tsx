  ...
  const compilations = [
    {
        ...
        info:         "split cassingle with Superflower released by Swannatopia",
    ...
    {
        title:        "Started As Piano (decayed mix)",
        release_date: "October31, 2025",
        info:         "Ingrown Records' Thinning Viel Compilation ",
        image_url:    "https://f4.bcbits.com/img/a1553848487_10.jpg",
        html:         `<iframe style="border: 0; width: 100%; height: 42px;" src="https://bandcamp.com/EmbeddedPlayer/album=2198068175/size=small/bgcol=333333/linkcol=e99708/track=1417224214/transparent=true/" seamless><a href="https://ingrown.bandcamp.com/album/thinning-veil-compilation">Thinning Veil Compilation by XOR</a></iframe>`,
        bandcamp:     "https://ingrown.bandcamp.com/album/thinning-veil-compilation",
        spotify:      "",
        official:     true,
    },
    {
        title:        "I don't see lights on the mountains anymore",
        release_date: "September 26, 2025",
        info:         "Of Landfall and Wildfires. Curated by Asheville, NC based Chandra Shukla (Erototox Decodings) and Tim Gormley (Ceremony of Seasons) immediately following the destruction of Western North Carolina by Hurricane Helene.",
        image_url:    "https://f4.bcbits.com/img/a0689991173_10.jpg",
        html:         `<iframe style="border: 0; width: 100%; height: 42px;" src="https://bandcamp.com/EmbeddedPlayer/album=580877659/size=small/bgcol=333333/linkcol=e99708/track=3262817062/transparent=true/" seamless><a href="https://ceremonyofseasons.bandcamp.com/album/of-landfall-and-wildfires">Of Landfall and Wildfires by Xor</a></iframe>`,
